...
这部分介绍了**如何定义字体的系列、大小、粗细、行高和文字样式等**。此部分基本是学习笔记，有一定基础的读者可选择性阅读，笔记主要出处有：“[黑马程序员 pink 老师前端入门教程](https://www.bilibili.com/video/BV14J4114768?p=72)” 、“[MDN 基本文本和字体样式](https://developer.mozilla.org/zh-CN/docs/Learn/CSS/Styling_text/Fundamentals)” 。
